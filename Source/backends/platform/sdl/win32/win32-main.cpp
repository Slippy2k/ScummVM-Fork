...
bool AppDataOptionExists(char** begin, char** end, const std::string& option)
{
...
int main(int argc, char *argv[]) {
	...
	// HACK: To Change the ScummVM Default Path.
	if (AppDataOptionExists(argv, argv + argc, "--useappdata"))
	{
		ConfMan.registerDefault("useappdata", true);
	}
	else {
		ConfMan.registerDefault("useappdata", false);
	}
