...
extern const char *const gSATURDAY;
extern const char *const gSUNDAY;
extern const char *const gMONDAY;
extern const char *const gAM;
extern const char *const gPM;

extern const char *const gSTART_OF_MESSAGE;
extern const char *const gEND_OF_MESSAGE;

extern const char *const gEVENT_TYPE_STRINGS[4];
...
extern const char *const gPIRACY_MESSAGE[];
