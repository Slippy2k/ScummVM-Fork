		...
		if (_vm->_voy->_RTANum & 2) {
			...
			if (_vm->getLanguage() == Common::EN_ANY) {
				if (_vm->_voy->_RTANum & 4) {
					...
					_vm->_screen->sDrawPic(pic, _vm->_screen->_vPort,Common::Point(215, 27));
				}
			}
				...
				if (_vm->_voy->_RTANum & 4) {
					if (_vm->_voy->_isAM) {
						_vm->_screen->drawANumber(_vm->_screen->_vPort,
							(_vm->_gameHour / 10) == 0 ? 10 : _vm->_gameHour / 10,
							Common::Point(161, 25));
						_vm->_screen->drawANumber(_vm->_screen->_vPort,
							_vm->_gameHour % 10, Common::Point(172, 25));
					}
						...
						_vm->_screen->drawANumber(_vm->_screen->_vPort,
							((_vm->_gameHour + 12) / 10) == 0 ? 10 : (_vm->_gameHour + 12) / 10,
							Common::Point(161, 25));
						_vm->_screen->drawANumber(_vm->_screen->_vPort,
							(_vm->_gameHour + 12) % 10, Common::Point(172, 25));
					}
					pic = _vm->_bVoy->boltEntry(_vm->_voy->_isAM ? 272 : 273)._picResource;
					_vm->_screen->sDrawPic(pic, _vm->_screen->_vPort, Common::Point(215, 27));
				}
