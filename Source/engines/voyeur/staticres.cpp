...
const char *const gSATURDAY = "Samstag";
const char *const gSUNDAY = "Sonntag";
const char *const gMONDAY = "Montag Morgen";
const char *const gAM = " Uhr";
const char *const gPM = " Uhr";

const char *const gSTART_OF_MESSAGE = "   *** TEXTANFANG ***   ";
const char *const gEND_OF_MESSAGE = "   *** TEXTENDE ***   ";

const char *const gEVENT_TYPE_STRINGS[4] = { "Video", "Audio", "Beweis", "Computer" };
...
const char *const gPIRACY_MESSAGE[] = {
	"VOYEUR",
